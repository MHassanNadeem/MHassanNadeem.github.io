...
% Awesome CV ` Template for CV/Resume
%
...
\mobile{+1-540-449-7385}
\email{hnadeem5@bloomberg.net}
\homepage{http://HassanNadeem.com}
\github{MHassanNadeem}
\linkedin{MHassanNadeem}
% \gitlab{gitlab-id}
